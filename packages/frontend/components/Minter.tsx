...
export const Minter = () => {
  ...
  const { state, send: mintFunction } = useContractFunction(contract, 'mint', {
    transactionName: 'minttx',
  })
  const { state: state2, send: setSaleActiveFunction } = useContractFunction(
    contract,
    'unpause',
    { transactionName: 'minttx' }
  )
