...
export interface GovernorVotesERC721QuorumFractionUpgradeableInterface
...
export interface GovernorVotesERC721QuorumFractionUpgradeable
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorVotesERC721QuorumFractionUpgradeableInterface;
