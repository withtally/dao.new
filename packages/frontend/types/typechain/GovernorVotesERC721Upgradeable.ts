...
export interface GovernorVotesERC721UpgradeableInterface
...
export interface GovernorVotesERC721Upgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorVotesERC721UpgradeableInterface;
