...
export const MinterInputs = ({
  ...
  return (
    <>
      <FormSectionHeader number="3" text="Minter"></FormSectionHeader>
      <FormSectionContent>
        <VStack spacing={6}>
          ...
          <FormControl id="minter-startblock" isRequired>
            ...
            <FormHelperText>
              ...
              Remember the final number should be the latest block plus the
              delay you want to add.
            </FormHelperText>
          </FormControl>
          <FormControl id="minter-type" isRequired>
            ...
            <FormHelperText>
              ...
              By token ID, means buyers will mint one-at-a-time, and get to
              choose a specific token ID to mint.
            </FormHelperText>
          </FormControl>
